package com.example.picmars.data.paging.opportunity
...
@Singleton
class OpportunityPagingSource @Inject constructor(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Photo> {
        ...
        return try {
            val response = picMarsApiService.getOpportunity(10, queryCamera, position)
